...
const vocabLists = {
    ...
    name: "La Voiture et La Route",
    categories: {
        noms: [
            { french: "une voiture hybride", english: "a hybrid car" },
            { french: "une voiture électrique", english: "an electric car" },
            { french: "une voiture de sport", english: "a sports car" },
            { french: "un VUS", english: "an SUV (abbreviation)" },
            { french: "un véhicule utilitaire sport", english: "an SUV (full)" },
            { french: "un break", english: "a wagon/hatchback" },
            { french: "une décapotable", english: "a convertible" },
            { french: "un camion", english: "a truck" },
            { french: "une camionnette", english: "a van" },
            { french: "un chauffeur", english: "a driver (professional)" },
            { french: "un conducteur", english: "a driver (cond...) (masculine)" },
            { french: "une conductrice", english: "a driver (cond...) (feminine)" },
            { french: "une moto", english: "a motorcycle" },
            { french: "une mobylette", english: "a scooter" },
            { french: "un casque", english: "a helmet" },
            { french: "l'embrayage", english: "a clutch" },
            { french: "la ceinture de sécurité", english: "a seatbelt" },
            { french: "une clé", english: "a key" },
            { french: "les essuie-glaces", english: "windshield wipers" },
            { french: "les freins", english: "brakes" },
            { french: "le GPS", english: "GPS" },
            { french: "les phares", english: "headlights" },
            { french: "une portière", english: "a car door" },
            { french: "une roue", english: "a wheel" },
            { french: "une roue de secours", english: "a spare tire" },
            { french: "un capot", english: "a hood" },
            { french: "un coffre", english: "the trunk" },
            { french: "un moteur", english: "an engine" },
            { french: "un/des pare-brise", english: "a windshield / windshields" },
            { french: "un/des pare-chocs", english: "the bumper / bumpers" },
            { french: "un pneu (crevé)", english: "a (flat) tire" },
            { french: "un réservoir d'essence", english: "a gas tank" },
            { french: "un rétroviseur", english: "a rearview mirror" },
            { french: "un volant", english: "a steering wheel" },
            { french: "un voyant d'essence/huile", english: "a gas/oil warning light" },
            { french: "un(e) mécanicien(ne)", english: "a mechanic (m/f)" },
            { french: "un policier", english: "a police officer (m.)" },
            { french: "une policière", english: "a police officer (f.)" },
            { french: "une station-service", english: "a gas station" },
            { french: "l'essence", english: "gas" },
            { french: "l'huile", english: "oil" },
            { french: "une amende", english: "a fine" },
            { french: "une autoroute", english: "a highway" },
            { french: "la circulation", english: "traffic" },
            { french: "un bouchon", english: "a traffic jam" },
            { french: "la limitation de vitesse", english: "the speed limit" },
            { french: "un panneau", english: "a street sign" },
            { french: "un parking", english: "a parking lot" },
            { french: "un permis de conduire", english: "a drivers license" },
            { french: "une rue", english: "a street" },
            { french: "un rond-point", english: "a roundabout" },
            { french: "un croisement", english: "an intersection" },
            { french: "un feu", english: "a traffic light" },
            { french: "une contravention", english: "a traffic ticket" },
            { french: "un péage", english: "a toll/toll booth" },
            { french: "une sortie", english: "an exit" },
            { french: "une voie", english: "a lane" }
        ],
        verbes: [
            { french: "accélérer", english: "to accelerate" },
            { french: "aller tout droit", english: "to go straight" },
            { french: "s'arrêter", english: "to stop" },
            { french: "attacher sa ceinture de sécurité", english: "to fasten your seatbelt" },
            { french: "avoir un accident", english: "to have an accident" },
            { french: "brûler un feu rouge", english: "to run a red light" },
            { french: "céder le passage", english: "to yield" },
            { french: "changer de voie", english: "to change lanes" },
            { french: "clignoter", english: "to signal" },
            { french: "conduire", english: "to drive" },
            { french: "dépasser la limite de vitesse", english: "to go over the speed limit" },
            { french: "doubler", english: "to pass" },
            { french: "faire le plein", english: "to fill up the gas" },
            { french: "freiner", english: "to brake" },
            { french: "mettre de l'air", english: "to put air in the tires" },
            { french: "mettre le contact", english: "to start the car" },
            { french: "ralentir", english: "to slow down" },
            { french: "rentrer dans", english: "to run into" },
            { french: "réparer", english: "to repair/fix" },
            { french: "respecter la limite de vitesse", english: "to stay under the speed limit" },
            { french: "rouler", english: "to go" },
            { french: "se garer", english: "to park (se g...)" },
            { french: "stationner", english: "to park (sta...)" },
            { french: "tomber en panne", english: "to break down" },
            { french: "tourner à gauche", english: "to turn left" },
            { french: "tourner à droite", english: "to turn right" },
            { french: "vérifier l'huile", english: "to check the oil" },
            { french: "vérifier la pression des pneus", english: "to check tire air pressure" }
        ]
    }
},'laTechnologie': {
    name: "La Technologie",
    categories: {
        verbes: [
            { french: "partager", english: "to share" },
            { french: "appuyer sur", english: "to press" },
            { french: "déverrouiller", english: "to unlock" },
            { french: "verrouiller", english: "to lock" },
            { french: "modifier", english: "to modify" },
            { french: "liker/aimer", english: "to like" },
            { french: "suivre", english: "to follow" },
            { french: "commenter", english: "to comment" },
            { french: "publier un commentaire", english: "to post a comment" },
            { french: "supprimer", english: "to delete" },
            { french: "sauvegarder", english: "to save" },
            { french: "se détendre", english: "to relax" },
            { french: "se divertir", english: "to entertain oneself" },
            { french: "enregistrer", english: "to record" },
            { french: "effacer", english: "to erase" },
            { french: "se servir de", english: "to use" },
            { french: "envoyer un texto", english: "to text" },
            { french: "glisser", english: "to swipe" },
            { french: "cliquer sur un lien", english: "to click on a link" },
            { french: "diffuser", english: "to broadcast" },
            { french: "faire partie de", english: "to be part of" },
            { french: "télécharger", english: "to upload / to download" },
            { french: "se connecter", english: "to sign in" },
            { french: "se déconnecter", english: "to sign out" },
            { french: "soumettre", english: "to submit" },
            { french: "se protéger", english: "to protect oneself" },
            { french: "sécuriser le profil", english: "to secure one's profile" },
            { french: "signaler", english: "to report" },
            { french: "avoir accès à", english: "to have access to" },
            { french: "donner le moyen de", english: "to allow to" },
            { french: "rester au courant de", english: "to stay informed" },
            { french: "se comporter bien", english: "to behave well" },
            { french: "se comporter mal", english: "to behave badly" }
        ],
        noms: [
            { french: "le wifi", english: "wifi" },
            { french: "un forum", english: "a forum" },
            { french: "le contenu", english: "the content" },
            { french: "une base de données", english: "a database" },
            { french: "la confidentialité", english: "privacy" },
            { french: "l'écran tactile", english: "a touchscreen" },
            { french: "une publication", english: "a post" },
            { french: "un portable", english: "a cell phone" },
            { french: "la couverture", english: "the cover" },
            { french: "une touche", english: "a key (on computer)" },
            { french: "un logiciel", english: "a software" },
            { french: "un pavé tactile", english: "a touchpad" },
            { french: "un clavier tactile", english: "a touch screen keypad / a touch screen keyboard" },
            { french: "le divertissement", english: "entertainment" },
            { french: "la réalité virtuelle", english: "virtual reality" },
            { french: "le moteur de recherche", english: "search engine" },
            { french: "un outil", english: "a tool" },
            { french: "un texto", english: "a text" },
            { french: "un SMS", english: "a text / SMS" },
            { french: "un message", english: "a message" },
            { french: "un compte", english: "account" },
            { french: "un abonnement", english: "a subscription" },
            { french: "un abonné", english: "a subscriber" },
            { french: "une abonnée", english: "a subscriber (feminine)" },
            { french: "le cyberharcèlement", english: "cyber bullying" },
            { french: "un réseau social", english: "a social network" },
            { french: "une menace", english: "the threat" },
            { french: "un(e) internaute", english: "a web user" },
            { french: "le plagiat", english: "plagiarism" },
            { french: "une pièce jointe", english: "an attachment" },
            { french: "une loi", english: "a law" },
            { french: "un identifiant", english: "a username" },
            { french: "un mot de passe", english: "a password" },
            { french: "le commentaire négatif", english: "negative comment" },
            { french: "la vie privée", english: "private life" }
        ],
        adjectifs: [
            { french: "numérique", english: "digital" },
            { french: "sans fil", english: "wireless" },
            { french: "cyberdépendent(e)", english: "cyberdependent (m/f)" },
            { french: "privé(e)", english: "private (m/f)" },
            { french: "prudent(e)", english: "careful (m/f)" },
            { french: "visé(e)", english: "targeted by (m/f)" },
            { french: "respectueux", english: "respectful (masculine)" },
            { french: "respectueuse", english: "respectful (feminine)" }
        ],
        expressions: [
            { french: "ailleurs", english: "elsewhere" },
            { french: "grâce à", english: "thanks to" },
            { french: "en un seul clic", english: "in one click" },
            { french: "j'ai le droit de", english: "I have the right to" },
            { french: "je choisis de", english: "I choose to" },
            { french: "la loi empêche (de)", english: "the law prevents" },
            { french: "la loi interdit (de)", english: "the law forbids" },
            { french: "la loi permet (de)", english: "the law permits" },
            { french: "afin de", english: "in order to" },
            { french: "être respectueux", english: "to be respectful (masculine)" },
            { french: "être respectueuse", english: "to be respectful (feminine)" }
        ]
    }
}
};